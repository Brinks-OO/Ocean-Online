...
export default function Page() {
  ...
  // useEffect(() => {
  //   debugger;
  //   const panelHidden = panelRef.current.getContent().ariaHidden
      ...
      >
        ...
        <SplitterPanel className='flex w-full' size={87} >
          ...
          >
            ...
            >
              <GridJob gridJobOnRun={gridJobOnRun} handleOnClickUnassignJob={handleOnClickUnassignJob} flagRefreshPage={flagRefreshPage} overNight={overNight} />
            </TabPanel>
